...
<body>
    <form id="form1" runat="server">
        ...
        <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
            <div class="container">
                <span class="navbar-brand text-white">Kakuro</span>
                    ...
                    <div class="card shadow">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex flex-wrap gap-2 mb-4">
                                ...
                                <asp:Button runat="server" ID="btnEasy"
                                    Text="Easy"
                                    CssClass="btn btn-outline-success"
                                    CommandArgument="Easy"
                                    OnClick="SelectDifficulty" />

                                <asp:Button runat="server" ID="btnMedium"
                                    Text="Medium"
                                    CssClass="btn btn-outline-warning"
                                    CommandArgument="Medium"
                                    OnClick="SelectDifficulty" />

                                <asp:Button runat="server" ID="btnHard"
                                    Text="Hard"
                                    CssClass="btn btn-outline-danger"
                                    CommandArgument="Hard"
                                    OnClick="SelectDifficulty" />
